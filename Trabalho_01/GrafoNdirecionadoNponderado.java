...
class Graph{
	...
	public void inserirArestsAux(AtomGraph a, int valor){
	...
	public void inserirArests(AtomGraph a, int valor){
		...
		for(AtomGraph i = a; inserido; i = i.prox){
			if(i.prox == null){
				...
				inserido = false;
				if(a.element != valor)
					inserirArestsAux(objectGraph[valor-1], a.element);
			}
		}
	}
